...
class {{cookiecutter.example_node_name}}(HelpfulNode):
    ...
    def __init__(self, **kwargs: Any):
        ...
        # Create a publisher
        self.publisher = self.create_publisher(String, "example_topic", qos_profile=qos_profile_services_default)
...
main = create_spin_function({{cookiecutter.example_node_name}})